...
${t}`)+"'";return e.implicitKey?s:pt(s,t,ln,os(e,!1))}function Ye(n,e){let{singleQuote:t}=e.options,s;if(t===!1)s=mt;else{let i=n.includes('"'),r=n.includes("'");i&&!r?s=un:r&&!i?s=mt:s=t?un:mt}return s(n,e)}var fn;try{fn=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch(n){fn=/\n+(?!\n|$)/g}function rs({comment:n,type:e,value:t},s,i,r){let{blockQuote:o,commentString:a,lineWidth:c}=s.options;if(!o||/\n[\t ]+$/.test(t)||/^\s*$/.test(t))return Ye(t,s);let l=s.indent||(s.forceBlockIndent||as(t)?"  ":""),u=o==="literal"?!0:o==="folded"||e===v.BLOCK_FOLDED?!1:e===v.BLOCK_LITERAL?!0:!No(t,c,l.length);if(!t)return u?`|
`:`>
...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new ne(_t(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let s=Object.assign({_directives:this.directives},this.options),i=new Te(void 0,s);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}};var On=Symbol("break visit"),Go=Symbol("skip children"),wr=Symbol("remove item");function Re(n,e){"type"in n&&n.type==="document"&&(n={start:n.start,value:n.value}),br(Object.freeze([]),n,e)}Re.BREAK=On;Re.SKIP=Go;Re.REMOVE=wr;Re.itemAtPath=(n,e)=>{let t=n;for(let[s,i]of e){let r=t==null?void 0:t[s];if(r&&"items"in r)t=r.items[i];else return}return t};Re.parentCollection=(n,e)=>{let t=Re.itemAtPath(n,e.slice(0,-1)),s=e[e.length-1][0],i=t==null?void 0:t[s];if(i&&"items"in i)return i;throw new Error("Parent collection not found")};function br(n,e,t){let s=t(e,n);if(typeof s=="symbol")return s;for(let i of["key","value"]){let r=e[i];if(r&&"items"in r){for(let o=0;o<r.items.length;++o){let a=br(Object.freeze(n.concat([[i,o]])),r.items[o],t);if(typeof a=="number")o=a-1;else{if(a===On)return On;a===wr&&(r.items.splice(o,1),o-=1)}}typeof s=="function"&&i==="key"&&(s=s(e,n))}}return typeof s=="function"?s(e,n):s}var In="\uFEFF",Ln="",Pn="",Ts="";function vr(n){switch(n){case In:return"byte-order-mark";case Ln:return"doc-mode";case Pn:return"flow-error-end";case Ts:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
